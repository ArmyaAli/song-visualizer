import { canvasContext, canvasHeight, canvasWidth, m__FPS } from "./state.js";
...
// TO-IMP: 2023-10-02
export const drawHorizontalBars = () => { canvasContext.clearRect(0, 0, canvasWidth, canvasHeight); }
export const drawPD = () => { canvasContext.clearRect(0, 0, canvasWidth, canvasHeight);  }
export const drawStars = () => { canvasContext.clearRect(0, 0, canvasWidth, canvasHeight); }